...
//        writeToAFile("/home/prajwal/Desktop/file3.txt",String.valueOf(components)+"\n");
//        Date date = new Date();
//        //Pattern for showing milliseconds in the time "SSS"
//        DateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
//        String stringDate = sdf.format(date);
//        String fileName = "/home/prajwal/Desktop/file2.txt";
//        try {
//            BufferedWriter out = new BufferedWriter(
//                    new FileWriter(fileName, true));
//            out.write("date ="+stringDate+"num of components = "+String.valueOf(components)+"\n");
//            out.close();
//        }
//        catch (IOException e) {
//            System.out.println("exception occoured" + e);
...
//        }
//        List l = readFileInList("/tmp/prs2.txt");
//        Random rd = new Random();
//
//        for(int i=0;i<components;i++){
//            if(l.contains(String.valueOf(i))){
//               // writeToAFile("/home/prajwal/Desktop/file3.txt","\n"+String.valueOf(i));
//                sumWeights = sumWeights + 1;
//                sum = sum + avg_val[i];
//            }else{
//                double rand=rd.nextDouble();
//                rand=rand*0.9;
//                //writeToAFile("/home/prajwal/Desktop/file3.txt",String.valueOf(rand));
//                sumWeights = sumWeights + rand;
//                avg_val[i] = avg_val[i] * rand;
//                sum = sum + avg_val[i];
//            }
//        }
//        return sum/(sumWeights);
        if(weights == null)
            return compute_mean(avg_val,components);
        double x=compute_mean(avg_val,components);
       // writeToAFile("/home/prajwal/Desktop/file3.txt","\ni am coming\n");
        double sum = 0d;
        for(int i=0;i<components;i++) {
//            writeToAFile("/home/prajwal/Desktop/file3.txt",String.valueOf(weights.get(i))+'\n');
            sumWeights = sumWeights + weights.get(i);
            avg_val[i] = avg_val[i] * weights.get(i);
            sum = sum + avg_val[i];
        }
//        writeToAFile("/home/prajwal/Desktop/file3.txt",String.valueOf(x)+" now= "+String.valueOf(sum/(sumWeights))+"\n");
        return sum/(sumWeights);
    }
